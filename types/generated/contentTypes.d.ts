...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    datepost: Schema.Attribute.DateTime & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiCompanyInfoCompanyInfo extends Struct.SingleTypeSchema {
  ...
  attributes: {
    about_desc: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 3;
      }>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    iso_img: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    video_homepage: Schema.Attribute.Media<'videos'>;
  };
}

export interface ApiContactUsContactUs extends Struct.SingleTypeSchema {
  collectionName: 'contacts_us';
  info: {
...
export interface ApiGalleriesGalleries extends Struct.CollectionTypeSchema {
  collectionName: 'gallery';
  info: {
    displayName: 'galleries';
    pluralName: 'gallery';
    singularName: 'galleries';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiServiceCategoryServiceCategory
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    services_contents: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiSliderHomepageSliderHomepage
  extends Struct.CollectionTypeSchema {
  collectionName: 'sliders_homepage';
  info: {
    displayName: 'slider homepage';
    pluralName: 'sliders-homepage';
    singularName: 'slider-homepage';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    gallery: Schema.Attribute.Relation<'oneToOne', 'api::galleries.galleries'>;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::slider-homepage.slider-homepage'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::galleries.galleries': ApiGalleriesGalleries;
      'api::service-category.service-category': ApiServiceCategoryServiceCategory;
      'api::services-content.services-content': ApiServicesContentServicesContent;
      'api::slider-homepage.slider-homepage': ApiSliderHomepageSliderHomepage;
